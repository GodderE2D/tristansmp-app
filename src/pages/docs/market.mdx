...
Only an item's enchantment data show for now. For example, an Unbreaking 3 elytra will show that it's Unbreaking 3, however a shulker box will not show its contents.
